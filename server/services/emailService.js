...
const crearHtml = ({ descripcion, tipoAsunto, tipoTema, anonimato, contacto, telefono, correo }, _id, index) => {
    ...
    <p style="color: #fff; font-size: 18px;text-align:center;">${descripcion}</p>
    `;
    ...
    if (anonimato === 'Si') {
        ...
        html += `<p style="color: #fff; font-size: 18px;text-align:center;">Contacto para resolucíon: Vía telefonica</p>`
